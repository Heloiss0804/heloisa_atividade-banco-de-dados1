...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/03/2025 às 15:33
...
--
CREATE DATABASE IF NOT EXISTS `tecinternet_escola_heloisa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tecinternet_escola_heloisa`;
...
(3, '2001-02-10', 9.00, 8.50, 'Carlos Mendes', 5),
(4, '2000-11-03', 7.50, 6.50, 'Daniela Rocha', 3),
(5, '1998-07-21', 5.50, 6.00, 'Eduardo Martins', 4),
(6, '2002-03-15', 8.00, 9.00, 'Fernanda Alves', 1),
(7, '2000-09-30', 7.00, 7.50, 'Gustavo Ribeiro', 3),
(8, '1999-12-14', 6.50, 5.50, 'Helena Castro', 4),
(9, '2001-06-05', 9.50, 8.00, 'Igor Nunes', 1),
(10, '1998-04-20', 7.00, 7.00, 'Juliana Freitas', 5);
